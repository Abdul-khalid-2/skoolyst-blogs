...
<head>
  ...
  <title>About \u2014 Skoolyst Blog</title>
  <meta name="description" content="Learn about the Skoolyst blog: our mission, our team, and why we write about education." />
...
<body>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      var roles = {
        a1: 'Lead Content Strategist',
        a2: 'EdTech Writer',
        a3: 'Online Learning Editor',
        a4: 'Education Policy Writer'
      };
      MOCK_AUTHORS.forEach(function (a) {
        var card = document.createElement('div');
        card.className = 'team-card';
        card.innerHTML =
          '<img src="' + a.avatar + '" alt="' + escapeHtml(a.name) + '" loading="lazy" />' +
          '<p class="team-name">' + escapeHtml(a.name) + '</p>' +
          '<p class="team-role">' + escapeHtml(roles[a.id] || 'Writer') + '</p>' +
