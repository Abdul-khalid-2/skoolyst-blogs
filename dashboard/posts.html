...
<head>
  ...
  <title>Posts \u2014 Skoolyst Blog Dashboard</title>
...
<body>
  <div class="dash-layout">
    ...
    <aside class="dash-sidebar">
      ...
      <ul class="sidebar-nav">
        ...
        <li><a href="posts.html" class="active"><span class="nav-icon">\u{1F4DD}</span> Posts</a></li>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      var sel = document.getElementById('posts-category');
      if (sel) {
