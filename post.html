...
<head>
  ...
  <title>Article \u2014 Skoolyst Blog</title>
  <meta name="description" content="Read the full article on the Skoolyst blog." />
  ...
  <article id="post-content">
    ...
    <section class="comments-section" id="comments-section">
      ...
      <form class="comment-form" id="comment-form-el">
        ...
        <p class="form-note">Comments are moderated. This is a demo \u2014 no real submission.</p>
      </form>
    </section>
  </article>
