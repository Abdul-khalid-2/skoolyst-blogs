...
<head>
  ...
  <title>Media \u2014 Skoolyst Blog Dashboard</title>
  ...
  <div class="dash-layout">
    ...
    <aside class="dash-sidebar">
      ...
      <ul class="sidebar-nav">
        ...
        <li><a href="media.html" class="active"><span class="nav-icon">\u{1F4F7}</span> Media</a></li>
        ...
        <div class="dash-card">
          <div class="card-body">
            <div class="media-upload-area" id="media-upload">
              <div class="upload-icon" aria-hidden="true">\u{1F4E4}</div>
